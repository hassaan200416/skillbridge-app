...
//
// Purpose: Customer notifications screen. Unified UI matching provider
//   and admin notifications. Uses CustomerSidebar layout.
//
// Route: /notifications  (customer route)
//
// ---------------------------------------------------------------------------
...
class CustomerNotificationsScreen extends NotificationsScreen {
...
class NotificationsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NotificationsScreen> createState() => _NotiState();
}

class _NotiState extends ConsumerState<NotificationsScreen> {
